...
function Hebergements() {
    return (
        <div>
            ...
            />
            <HebergementsSection
                title="À Chaux-Neuve et dans les environs, profitez d'une vaste gamme d'hébergement à la montagne."
                paragraph="Avec un choix de 45 hôtels, allant du 2 au 4 étoiles, ce secteur vous offre une variété d'options d'hébergement exceptionnelles. Chaque hôtel se distingue par son décor et son ambiance unique, créant une expérience de séjour personnalisée..."
