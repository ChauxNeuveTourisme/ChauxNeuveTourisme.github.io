...
function Mentions() {
    return (
        <section className="max-w-screen-3xl mx-auto relative bg-light dark:bg-basis-90 px-16 xl:px-80 2xl:px-[104px] py-64 xl:py-[104px] 2xl:py-[128px]">
            <header className="border-b border-gray-300 dark:border-gray-700 mb-8 flex flex-wrap items-center justify-between gap-16 pb-12">
                <section>
                    <h2 className="text-3xl font-bold text-basis-95 dark:text-light">
                    Responsable éditorial :
                    </h2>
                </section>
                <div className="flex flex-col items-center gap-24 md:flex-row">
                  {/* You can add action buttons or links here */}
                    <p>Sébastien POPULAIRE : Président de l'Office de Tourisme du Pays du Haut-Doubs</p>
                    <p>Aurélie ROY : Directrice de l'Office de Tourisme du Pays du Haut-Doubs</p>
                </div>
            </header>

        <div className="grid grid-cols-1 text-balance text-base leading-relaxed space-y-6">
            <h2>Site internet en ligne numérique « chaux-neuve tourisme »</h2>
            <p><em>Version du 01.01.2025</em></p>

            <h3 className="font-semibold text-lg mt-8">Crédits photos : :</h3>
            <p>
            Benjamin Becker - Base nautique des Grangettes - Quentin Dornier - Valentin Bsy - ESI Evasions nordiques - Cyril Di Marca - Vanessa Andrieux - Thuria - A. Mouchet – P. Jouille – P. Vallet – M. Bévalot – Pixabay - OT de Pontarlier – J. Varlet – S. Cousin – Y. Perton – Y. Binot – F. Parriaux – C. Berguer – L. Cheviet – CFD – les Amis du Musée – G. Perret/Route de l’Absinthe – Ville de Pontarlier – CVMA - ESF – CIGC Poligny – Chat Gris Freestyle – S. Marcel – Rousset – P. Dornier – D. Jacquot – CCGP – ESF – D. Bouthiaux - Marc Faivre - A. Loye - M. Humbert - OT Mont d'Or 2 Lacs - Circuit de l'Enclos - Publipresse - J. Vigouret - M. Eme - T. Pighin - Y. Blachère - K. Comte - M. Dupuis - P. Guyon - P. Nicolas - V. Liger - B. Wiszniewski - B. Bonnet - C. Mainy - C. Rousset - C. Blondeau - C. Louvrier - D. Viry - E. Osada - CRTFC - CPPR - Dartagnan - R. Fabregue - M. Dalmasso - So Nordic - Native - Fischer - Graphic Obsession - Thomas Hytte - Stephane Cervos - Agence photo Urope - Y. Véjux - G. Gresset - E. Rousse - Ecomusée Maison Michaud - Tremplins de Chaux Neuve - LG - Laurent Cheviet - C. Burri - Doubs Tourisme - Ph. Simon - M. Joly - G. Hérard - M. Bracchetto - G. Malloire - B. Faivre Chalon - J. Hann - S. Chatelain - Lynko - SMMO - J.Y et C. Aebischer - V. Robbe - E. Bourque - M Humbert - C. Viey - ©BestPhotoStudio Fotolia.com - Espace Nordique Jurassien
            </p>

            <h3 className="font-semibold text-lg mt-8">Crédits vidéos :</h3>
            <p>
                Jules Pourchet - Cheni Films
            </p>

            <h3 className="font-semibold text-lg mt-8">Développement et Hébergement : moi </h3>
            <p>210 Rue des Sept Laux - 38570 Le Cheylas - France</p>
            <p>Tél : +33 (0)..... - Fax : +33 (0)..... -</p>
